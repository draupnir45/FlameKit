...
protocol FlameNavigationBarDelegate: class {
  func flameNavigationBarDidResizeHeightTo(_ barHeight: CGFloat)
}

class FlameNavigationBar: UIView, UIGestureRecognizerDelegate, UIScrollViewDelegate {
  // ----------------------------------------
  ...
  weak var delegate: FlameNavigationBarDelegate?
  ...
  var largeTitleAttributes = NSAttributedString.attributes(font: UIFont.boldSystemFont(ofSize: 34.0), color: UIColor.black)
  ...
  var title: String? {
    didSet {
      ...
      UIView.animate(withDuration: 1) {
        self.largeTitleLabel.attributedText = 
          NSAttributedString.init(
            string: title, 
            attributes: self.largeTitleAttributes)
